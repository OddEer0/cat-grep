...
void parseGrepTemplateTest() {
	...
	int argc = 6;
	const char* argv[] = {"./grep", "-e", "template-added", "filename", "-e", "template-added-2"};
	...
	int argc2 = 6;
	const char* argv2[] = {"./grep", "-f", "template.txt", "filename", "-f", "template2.txt"};
	...
	int argc3 = 6;
	const char* argv3[] = {"./grep", "-f", "template.txt", "filename", "-f", "template3.txt"};
